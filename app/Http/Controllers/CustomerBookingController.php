...
class CustomerBookingController extends Controller
{
    public function makeABooking()
    {
        ...
        return view('booking.make-a-booking', ['customers' => $customers, 'title' => 'Create a Laundry Request', 'mainCategories' => $mainCategories, 'weightCategories' => $weightCategories]);
    }
    ...
    public function editTempBooking(Request $request)
    {
        ...
        return response()->json(['success' => 'Booking edit successfully.']);
    }
    ...
    public function saveBooking(Request $request)
    {
        ...
        if ($request['index']) {
            if ($request['radioButtonValue'] == 'normal') {
                $validator = \Validator::make($request->all(), [
                ...
                $validator = \Validator::make($request->all(), [
                    ...
                    'wCustomer.required' => 'Customer Type should be provided!',
        ...
        if($request['index']){
            if ($request['radioButtonValue'] == 'normal') {
                $save->user_master_iduser_master = $request['customer'];
            }else{
                $save->user_master_iduser_master = $request['wCustomer'];
            }
        }else{
            $save->user_master_iduser_master = Auth::user()->iduser_master;
        }
        ...
        foreach ($tempBooking as $temp) {
            ...
            $price = CategoryPrice::find($temp->main_category_idmain_category);
            $saveBooking->bp = $price->price;
