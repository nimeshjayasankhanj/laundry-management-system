...
!function ($) {
    ...
    var Dashboard = function () {
        ...
        Dashboard.prototype.init = function () {
            ...
            this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#009688','#2796f0']);
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#ccc', '#009688', '#2796f0']);
            ...
            this.createDonutChart('morris-donut-example', $donutData, ['#f0f1f4', '#009688', '#2796f0']);
