...
button:{className:"btn btn-secondary"},collection:{tag:"div",className:"dt-button-collection dropdown-menu",button:{tag:"a",className:"dt-button dropdown-product"}}}});a.ext.buttons.collection.className+=" dropdown-toggle";return a.Buttons});
