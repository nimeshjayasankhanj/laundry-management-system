            ...
            <div class="col-lg-8">
                <div class="card m-b-20">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="example-text-input" class="col-form-label">Products<span
                                            style="color: red"> *</span></label>
                                    <select class="form-control select2 tab" name="product"
                                        onchange="getAvailableQty(this.value)" id="product">
                                        <option value="" disabled selected>Select Product
                                        </option>
                                        @if (isset($items))
                                            @foreach ($items as $item)
                                                <option value="{{ "$item->idproduct" }}">{{ $item->product_name }}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="availableQty" id="availableQty"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="qty" id="qty" placeholder="0.00" />
                    ...
                    <div class="row" id="bookingButton">
                        ...
                        <div class="col-lg-4">
                            @if ($paymentStatus->payment_type == 1)
                                <button type="button" data-toggle="modal" data-target="#paymentModal"
                                    class="btn btn-primary" id="saveBookingBtn">
                                    Save Invoice</button>

                            @else
                                <button type="button" onclick="saveInvoice()" class="btn btn-primary"
                                    id="saveBookingBtn">
                                    Save Invoice</button>
                            @endif
                        </div>
...
<div class="modal fade" id="updateCategoryModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="" method="post" enctype="multipart/form-data" action="{{ route('editTempInvItem') }}"
                    id="editTempItemId">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <label for="example-text-input" class="col-form-label">Products<span style="color: red">
                                *</span></label>
